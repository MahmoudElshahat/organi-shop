            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__pic">
                        ...
                        <div class="product__details__pic__slider owl-carousel">
                            ...
                            <img data-imgbigurl="{{asset('assets/front/img/product/details/product-details-3.jpg')}}"
                                src="{{asset('assets/front/img/product/details/thumb-2.jpg')}}" alt="">
                            <img data-imgbigurl="{{asset('assets/front/img/product/details/product-details-5.jpg')}}"
                                src="{{asset('assets/front/img/product/details/thumb-3.jpg')}}" alt="">
                            <img data-imgbigurl="{{asset('assets/front/img/product/details/product-details-4.jpg')}}"
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        @endforeach --}}
                        <div class="product__details__price">${{session()->get('id')}}</div>
