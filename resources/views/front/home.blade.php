                ...
                <div class="col-lg-3">
                    <div class="hero__categories">
                        <div class="hero__categories__all">
                            ...
                            <span>{{__('messages.Alldepartments')}}</span>
                        </div>
                        {{-- ############## side bar #################### --}}
  ...
  <section class="categories">
        <div class="container">
            <div class="row">
                ...
                <div wire:loading class="categories__slider owl-carousel">

                    @foreach ($products as $product )
                    <a  href="{{route('cart.add',$product->id)}}">
                        <div class="col-lg-3">
                         <div class="categories__item set-bg" alt="product image" data-setbg="{{asset('images/products/'.$product->image)}}">
                            <h5>{{$product->name}}</h5>
                        </div>
                      </div>
                    </a>
            ...
            <div class="row featured__filter">
                    {{-- ================== pro by section ========================== --}}
                     @foreach ($cat_product as $product)
                            ...
                            <div wire:ignore class="col-lg-3 col-md-4 col-sm-6 mix oranges fresh-meat">
                                <div class="featured__item">
                                    <a href=""></a>
                                    <div class="featured__item__pic set-bg" wire:ignore data-setbg="{{asset('images/products/'.$product->image)}}">
                ...
                {{-- @if($show_section==true) --}}
                      @foreach ($products as $product)
                      {{-- @if($cat_product == $product->categorie_id) --}}
                            <div wire:ignore.self  class="col-lg-3 col-md-4 col-sm-6 mix oranges fresh-meat">
                                <div class="featured__item">
                                    <div class="featured__item__pic set-bg"  data-setbg="{{asset('images/products/'.$product->image)}}">
                                        <ul class="featured__item__pic__hover">
                                            <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                            <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                            <li><a href="" wire:click="add({{$product-> id}})"><i class="fa fa-shopping-cart"></i></a></li>
