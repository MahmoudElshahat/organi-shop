            ...
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                           <span  class="mr-1">Welcome </span>
                             ...
                             <span style="color:aliceblue;font-size:25px">{{session('user_name')}}</span>
                        ...
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href=""><i
                            ...
                            <a href="{{ route('admin.logout') }}" class="dropdown-item"> <i class="ft-power"></i> Log out  </a>
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <a class="nav-link nav-link-label" href="{{route('home')}}" >Home</li></a>

                  <ul>
                @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                    <li data-toggle="dropdown">

                        <a style="color:white"  class="mr-1" rel="alternate" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
                            {{ $properties['native'] }}
                        </a>
                    </li>
                @endforeach
