                                ...
                                <div class="card-body card-dashboard">
                                    ...
                                    <table
                                        ...
                                        <tbody>
                                            ...
                                            @if($categorie_data)
                                            @foreach($categorie_data as $category)
                                                <tr>
                                                    ...
                                                    <td>
                                                         <img
                                                    src="{{asset('images/categorie/'.$category->image)}}"
                                                    ...
                                                    <td>
                                                        <div class="btn-group" role="group"
                                                            ...
                                                            <a href="{{route('edite.categori',[$category->id,$category->slug])}}"
                                                               class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">تعديل</a>

                                                                {{-- <a href="{{route('edite.categori',$category->id)}}"
                                                               class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">تعديل</a> --}}
